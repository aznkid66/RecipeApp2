...
public class RecipeProvider extends ContentProvider {
    ...
    private static final SQLiteQueryBuilder sRecipeQueryBuilder;

    static{
        sRecipeQueryBuilder = new SQLiteQueryBuilder();

        sRecipeQueryBuilder.setTables(
                RecipeContract.RecipeEntry.TABLE_NAME);
    }


    //recipe.name = ?
    private static final String sRecipeNameSelection =
            RecipeContract.RecipeEntry.TABLE_NAME+
    ...
    private Cursor getRecipe(
        ...
        String recipeName = RecipeContract.RecipeEntry.getRecipeNameFromUri(uri);

        return sRecipeQueryBuilder.query(mOpenHelper.getReadableDatabase(),
                projection,
                sRecipeNameSelection,
